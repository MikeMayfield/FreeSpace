...
//        CompressionServiceBackgroundTask.CompressionLevel(80, 0, 0, 0), // Level 0: Original, 0 days old
...
//        `when`(mockCloudStorageFactory.cloudStorage(any(), any())).thenReturn(mockCloudStorage)
...
//        // Given
//        val mediaFile1 = MediaFile(1, fullPath = "path1", originalSize = 100, width = 1920, height = 1080, mediaType = MediaType.IMAGE, currentCompressionLevel = 0, desiredCompressionLevel = 1,
//            creationDtm = 0L, modifiedDtm = 0L, isOnServer = false)
//        val mediaFile2 = MediaFile(1, fullPath = "path2", originalSize = 100, width = 1920, height = 1080, mediaType = MediaType.VIDEO, currentCompressionLevel = 0, desiredCompressionLevel = 1,
//            creationDtm = 0L, modifiedDtm = 0L, isOnServer = false)

...
fun LicenseScreen(navController: NavHostController, paddingValues: PaddingValues) {
    GenericTextBody(
        ...
        title = "LICENSE",
        bodyHtml =
            "Like all professional apps, FreeSpace comes with a <u><font color=blue>License Agreement</font></u> — basically, it’s there to outline how we work together. It clearly states that we <b>never collect or share</b> your personal information with anyone. Your privacy stays 100% yours.<br><br>" +
